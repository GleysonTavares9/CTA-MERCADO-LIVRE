...
export const ProductPoster: React.FC<ProductPosterProps> = ({
    ...
    return (
        <div className={`relative w-full max-w-4xl mx-auto bg-gradient-to-br ${backgroundColor} rounded-3xl overflow-hidden shadow-2xl`}>
            ...
            <div className="p-10 flex flex-col lg:flex-row items-center justify-between min-h-[500px]">
